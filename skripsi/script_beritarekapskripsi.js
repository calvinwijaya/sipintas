...
async function generateBeritaAcaraDoc() {
    ...
    try {
        const response = await fetch("3_Form Nilai Akhir Skripsi.docx");
        ...
        const fileName = `Nilai AKhir Skripsi - ${safeNama}.docx`;
...
document.addEventListener("DOMContentLoaded", () => {
    document.getElementById("btnPrintRekapSkripsi").
