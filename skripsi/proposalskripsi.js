...
async function loadProposalSkripsiData() {
    ...
    try {
        ...
        proposalSkripsiRows.forEach(r => {
            ...
            if (role === "admin") {
                const sudahKetua   = !!r[18];
                const sudahPenguji1 = !!r[27];
                const sudahPenguji2 = !!r[36];
                ...
                <div class="col-md-6">
                    <div class="card shadow-sm h-100" style="border-top: 5px solid ${statusColor}; background-color: ${bgColor};">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            ${role !== "admin" ? `
                                <a href="skripsi/page_penilaianproposalskripsi.html?${encodedParams}" 
                            ...
                            ${role === "ketuaSidang" || role === "admin" ? `
                                <a href="skripsi/page_beritaproposalskripsi.html?${encodedParams}" class="btn btn-outline-primary btn-sm">
                                    Buat Berita Acara
                                </a>
                            ` : ""}
                            </div>
