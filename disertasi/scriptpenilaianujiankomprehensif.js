document.addEventListener("DOMContentLoaded", () => {
    ...
    btnPrint.addEventListener("click", async () => {
        try {
            ...
            data["JudulProposal"] = mahasiswaData.judul;
            // Selected "hasil"
            ...
            const response = await fetch("1_Form Penilaian Ujian Komprehensif.docx");
            ...
            const fileName = `Penilaian Ujian Komprehensif - ${safeNama}.docx`;
    ...
    document.getElementById("btnKirim").addEventListener("click", async () => {
        ...
        fetch("https://script.google.com/macros/s/AKfycbyAGBAeSH_RY2cO1acxeGqJyvyYMPBe_YTV8HyZTSegWQScEqbSLsB8AIsl_cqhyY8q-Q/exec", {
            method: "POST",
            body: formBody
        })
            .then(res => res.json())
