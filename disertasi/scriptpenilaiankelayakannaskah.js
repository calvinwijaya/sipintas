document.addEventListener("DOMContentLoaded", () => {
    ...
    btnPrint.addEventListener("click", async () => {
        try {
            ...
            const response = await fetch("4_Form Penilaian Kelayakan Naskah Disertasi.docx");
            ...
            const fileName = `Penilaian Kelayakan Naskah Disertasi - ${safeNama}.docx`;
    ...
    document.getElementById("btnKirim").addEventListener("click", async () => {
        ...
        fetch("https://script.google.com/macros/s/AKfycbza5SKkkUSX2Ap2WMTBxtyTAI6wyvFftt8bNJxvvyaym80AaJAgDd4TRah3aiNU_7pN4g/exec", {
            method: "POST",
            body: formBody
        })
            .then(res => res.json())
