...
async function generateBeritaAcaraDoc() {
    ...
    try {
        const response = await fetch("3_Form BA Seminar 2.docx");
        ...
        const fileName = `BA Seminar 2 - ${safeNama}.docx`;
...
// Bind to button
document.getElementById("btnPrintBASeminar2").addEventListener("click", generateBeritaAcaraDoc);