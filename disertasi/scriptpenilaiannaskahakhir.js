document.addEventListener("DOMContentLoaded", () => {
    ...
    btnPrint.addEventListener("click", async () => {
        try {
            ...
            const response = await fetch("7_Form Penilaian Naskah Akhir.docx");
            ...
            const fileName = `Penilaian Naskah Akhir - ${safeNama}.docx`;
    ...
    document.getElementById("btnKirim").addEventListener("click", async () => {
        ...
        fetch("https://script.google.com/macros/s/AKfycbwF5Gtm0pIpSBvWDSRGSlj-i0K90gZPhO9X4MsFuX2z1oAizcJlo2176MPGPgW4R-s0Nw/exec", {
            method: "POST",
            body: formBody
        })
            .then(res => res.json())
