document.addEventListener("DOMContentLoaded", () => {
    ...
    btnPrint.addEventListener("click", async () => {
        try {
            ...
            const response = await fetch("3_Form Penilaian Seminar 2.docx");
            ...
            const fileName = `Penilaian Seminar 2 - ${safeNama}.docx`;
    ...
    document.getElementById("btnKirim").addEventListener("click", async () => {
        ...
        fetch("https://script.google.com/macros/s/AKfycbzYoKr548pVpFwkAsIDDS2QRryZIMD-sv2wghljd3MQZYwnQanJCJDrj1Srb4l4wvl93w/exec", {
            method: "POST",
            body: formBody
        })
            .then(res => res.json())
