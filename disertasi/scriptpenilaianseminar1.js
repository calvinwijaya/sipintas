document.addEventListener("DOMContentLoaded", () => {
    ...
    btnPrint.addEventListener("click", async () => {
        try {
            ...
            const response = await fetch("2_Form Penilaian Seminar 1.docx");
            ...
            const fileName = `Penilaian Seminar 1 - ${safeNama}.docx`;
    ...
    document.getElementById("btnKirim").addEventListener("click", async () => {
        ...
        fetch("https://script.google.com/macros/s/AKfycbyOQMJ0HKQPRtAdp7nWQcS1qHbTDEouf5llfCfrW11r332MjsH_GEH3OaKRRAMf3taLBw/exec", {
            method: "POST",
            body: formBody
        })
            .then(res => res.json())
