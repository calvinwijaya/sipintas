...
function collectBeritaAcaraData() {
    ...
    data["JudulProposal"] = params.get("judul") || "";
...
async function generateBeritaAcaraDoc() {
    ...
    try {
        const response = await fetch("1_Form BA Ujian Komprehensif.docx");
        ...
        const fileName = `BA Ujian Komprehensif - ${safeNama}.docx`;
...
// Bind to button
document.getElementById("btnPrintBAUjianKomprehensif").addEventListener("click", generateBeritaAcaraDoc);