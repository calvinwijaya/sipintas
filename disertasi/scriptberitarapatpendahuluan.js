...
async function generateBeritaAcaraDoc() {
    ...
    try {
        const response = await fetch("4_Form BA Rapat Pendahuluan Kelayakan Naskah dan Publikasi.docx");
        ...
        const fileName = `BA Rapat Pendahuluan - ${safeNama}.docx`;
...
// Bind to button
document.getElementById("btnPrintBARapatPendahuluan").addEventListener("click", generateBeritaAcaraDoc);