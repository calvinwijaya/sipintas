document.addEventListener("DOMContentLoaded", () => {
    ...
    btnPrint.addEventListener("click", async () => {
        try {
            ...
            const response = await fetch("8_Form Penilaian Kinerja.docx");
            ...
            const fileName = `Penilaian Kinerja - ${safeNama}.docx`;
    ...
    document.getElementById("btnKirim").addEventListener("click", async () => {
        ...
        fetch("https://script.google.com/macros/s/AKfycbwgDtqWFt47TYlzYg_8W1wolFN4ANhLupNf-8WlWjyKZ3Wduy70MaXjDP6qPjjfFPPb/exec", {
            method: "POST",
            body: formBody
        })
            .then(res => res.json())
