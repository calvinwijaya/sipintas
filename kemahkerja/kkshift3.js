async function loadKKShift3Data() {
    ...
    try {
        ...
        const KKShift3Rows = rows.filter(r => r[0]?.trim().toLowerCase() === "shift 3");
        console.log("KK Shift 3 rows:", KKShift3Rows);
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="kemahkerja/page_penilaiankkshift3.html?${encodedParams.toString()}" 
