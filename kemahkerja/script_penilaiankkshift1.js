...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("btnKirim").addEventListener("click", async () => {
        ...
        fetch("https://script.google.com/macros/s/AKfycbwzRoF0I-YWAhsYoea23aS0zFi252xLSAhTv04ZwmWhgtkUOndtgLBH9UVUzz9hBji7Ag/exec", {
            method: "POST",
            body: formBody
        })
            .then(res => res.json())
    ...
    function showModal({ type, title, message }) {
        ...
        window.location.href = "../index.html?page=kkshift1";
        });
});
