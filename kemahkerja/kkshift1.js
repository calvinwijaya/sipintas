async function loadKKShift1Data() {
    ...
    try {
        ...
        const KKShift1Rows = rows.filter(r => r[0]?.trim().toLowerCase() === "shift 1");
        console.log("KK Shift 1 rows:", KKShift1Rows);
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="kemahkerja/page_penilaiankkshift1.html?${encodedParams.toString()}" 
