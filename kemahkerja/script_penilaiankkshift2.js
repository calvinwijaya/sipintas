...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("btnKirim").addEventListener("click", async () => {
        ...
        fetch("https://script.google.com/macros/s/AKfycby7yzJi8aWTOZncPJ7NaxJcLtYKLD9cX3O9arGYG6Sonz6lGKVz9jvsU1zzps0AbLz1JA/exec", {
            method: "POST",
            body: formBody
        })
            .then(res => res.json())
    ...
    function showModal({ type, title, message }) {
        ...
        window.location.href = "../index.html?page=kkshift2";
        });    
});
