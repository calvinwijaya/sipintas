...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("btnKirim").addEventListener("click", async () => {
        ...
        fetch("https://script.google.com/macros/s/AKfycbyGl9k1QB_NDUJyObcSAq_v3xcKtOdGdviHRmiztVMK9iVPlvzI2Pvt9PbL9aE7gbSf/exec", {
            method: "POST",
            body: formBody
        })
            .then(res => res.json())
    ...
    function showModal({ type, title, message }) {
        ...
        window.location.href = "../index.html?page=kkstudio";
        });
});
