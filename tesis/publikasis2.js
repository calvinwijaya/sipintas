...
async function loadPublikasiS2Data() {
    ...
    try {
        ...
        publikasiS2Rows.forEach(r => {
            ...
            const COL_LINK = 14; 
            const linkGoogleDrivePublikasiTesis = r[COL_LINK] || "";
            ...
            const encodedParams = new URLSearchParams({ nama, nim, pembimbing, judul, linkGoogleDrivePublikasiTesis, role }).toString();
                ...
                <div class="col-md-6">
                    <div class="card shadow-sm h-100" style="border-top: 5px solid ${statusColor}; background-color: ${bgColor};">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            ${role !== "admin" ? `
                                <a href="tesis/page_penilaianpublikasimagister.html?${encodedParams}" 
                            ...
                            ${role === "ketuaSidang" || role === "admin" ? `
                                <a href="tesis/page_beritapublikasimagister.html?${encodedParams}" class="btn btn-outline-primary btn-sm">
                                    Buat Berita Acara
                                </a>
                            ` : ""}
                            </div>
