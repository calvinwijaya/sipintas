...
async function generateBeritaAcaraDoc() {
    ...
    try {
        const response = await fetch("template_beritapublikasimagister.docx");
        ...
        const fileName = `BA_Penilaian_Naskah_Publikasi-${safeNama}.docx`;
...
// Bind to button
document.getElementById("btnPrintBAPublikasiMagister").addEventListener("click", generateBeritaAcaraDoc);